...
var $mobileDet = void 0;
var $menuSelect = void 0;
var $menu = void 0;
var mobile = exports.mobile = false;

//initializes variables whenever the page is loaded
function startUp() {
    $mobileDet = $(".mobile-detection");
    exports.mobile = mobile = $mobileDet.width() > 0;

    // Set up menu and menu button for mobile
    $menuSelect = $(".menu-button");
    $menu = $(".mobile-nav");
    var $menuXDiv = $menu.find("div");
...
function lazyLoad() {
    ...
    $("head").append('<link rel="stylesheet" type="text/css" href="https://fonts.googleapis.com/css?family=Raleway:200,400,800,1000">');

    // images
    var $lazyLoadImages = $("img.lazy-load").toArray();
    ...
    var $lazyLoadBackgrounds = $("div.lazy-load").toArray();
...
var $tTextCont = void 0,
    $tCont = void 0,
    $tNavCont = void 0,
    $slows = void 0,
    $modal = void 0,
    $projectHeadT = void 0,
    $projectHeadCont = void 0,
    $wrapper = void 0,
    $projectDesc = void 0,
...
var projectsArray = exports.projectsArray = {
    ...
    GK: {
        title: "Gate Keeper",
        description: "<p>Gate Keeper is a project made by a four man team at HackGSU. We wanted an easy, secure way for people to grant access to buildings and to alleviate the need to check in at the front desk everywhere you go.</p>" + "<p>This solution provides a robust admin system to manage access, secured using asymmetric elliptic curve encryption. Additionally, we built an intuitive app for users to easily gain access to secured locations through NFC.</p>" + '<h5 class="bold">GitHub server repo: </h5><div class="btn btn-warning contact-button"><a class="contact-a" href="https://github.com/bentemplin/gatekeeper-server" target="_blank"></a><i class="fa fa-github"></i> GitHub</div>' + '<h5 class="bold">GitHub client repo: </h5><div class="btn btn-warning contact-button"><a class="contact-a" href="https://github.com/bentemplin/gatekeeper-app" target="_blank"></a><i class="fa fa-github"></i> GitHub</div>' + '<h5 class="bold">Read more: </h5><div class="btn btn-default contact-button"><a class="contact-a" href="https://devpost.com/software/gatekeeper-v43jwb" target="_blank"></a> Devpost</div>'
    },
    ER: {
        title: "ER Schedule",
        description: "<p>This is a PHP based web app that creates work schedules for Emergency Rooms, a task that normally takes an employee a full day to do.</p>" + "<p>I surveyed local Emergency Room for the required features such an app would need. My solution accounted for preferred and required days off, preferred number of shifts, number of shifts worked in a row, number of weekends worked in a row, number of holidays worked, etc.<p>" + '<h5 class="bold">GitHub repo: </h5><div class="btn btn-warning contact-button"><a class="contact-a" href="https://github.com/crschriever/ER-Schedule" target="_blank"></a><i class="fa fa-github"></i> GitHub</div>'
    },
    NEAT: {
        title: "NEAT",
        description: "<p>NEAT stands for Neuro-Evolution of Augmenting Topologies. It is a machine learning algorithm that creates and updates neural networks using genetic based evolution. I made my own implementation of this algorithm in Java.</p>"
    },
    dSA: {
        title: "deSchApps",
        description: "<p>A support website made with php for the iPhone Apps I created. The website had a CMS used for easy addition of new Apps. I created an Admin Dashboard that displayed current apps and allowed you to add new apps.</p>"
    },
    HH: {
        title: "Homework Help",
        description: "<p>Homework Help combines scrap paper and a calculator into one app and provides a means of sorting assignments.</p>" + "<p>Through this project I learned XCode and Objective C. I collaborated with a graphic design artist and won a congressional STEM competition.</p>"
    },
    IGW: {
        title: "Intergalactic Warfare",
        description: "Intergalactic Warfare is an iPhone game that consists of firing missiles at your opponents. These missiles must travel through an obstacle course of planets that all have a gravitational pull that affects the path of the missile. It was written in Objective C."
    },
    DS: {
        title: "Darlington School App",
        description: "This is an app created for my high school to display students' grades, assignments, announcements, schedules, etc. It was written with HTML, CSS, and JavaScript all through PhoneGap. This is the project I used to learn JQuery. I worked closely with IT staff to gain access to high school’s data."
    }
};
...
var map = {
	...
	"./Schedule.jpg": 17,
	"./google-home.jpg": 18,
	"./gt-overview-small.jpg": 19,
	"./gt-overview.jpg": 20,
	"./information-internetworks-threads.png": 21,
...
module.exports = __webpack_require__.p + "res/Cicerone-icon.jpg";

/***/ }),
/* 9 */
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__.p + "res/DSA.jpg";

/***/ }),
/* 10 */
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__.p + "res/Dar.jpg";

/***/ }),
/* 11 */
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__.p + "res/GateKeeper.jpg";

/***/ }),
/* 12 */
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__.p + "res/HW.jpg";

/***/ }),
/* 13 */
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__.p + "res/Headshot.jpg";

/***/ }),
/* 14 */
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__.p + "res/IG.jpg";

/***/ }),
/* 15 */
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__.p + "res/NEAT.jpg";

/***/ }),
/* 16 */
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__.p + "res/Resume.pdf";

/***/ }),
/* 17 */
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__.p + "res/Schedule.jpg";

/***/ }),
/* 18 */
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__.p + "res/google-home.jpg";

/***/ }),
/* 19 */
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__.p + "res/gt-overview-small.jpg";

/***/ }),
/* 20 */
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__.p + "res/gt-overview.jpg";

/***/ }),
/* 21 */
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__.p + "res/information-internetworks-threads.png";

/***/ }),
/* 22 */
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__.p + "res/intelligence-threads.png";

/***/ }),
/* 23 */
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__.p + "res/klaus.jpg";

/***/ }),
/* 24 */
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__.p + "res/lambda-java-wizard-logo.png";
